...
public class AddIO extends MainIO {
    ...
    public static void add_contact() throws IOException, FileNotFoundException {
        File file1 = new File("C:\\Users\\hp\\IdeaProjects\\JavaI\\AddressBookJavaFileIO\\src\\contact.txt");// we get the file
        ...
        OutputStreamWriter writer1 = new OutputStreamWriter(
                new FileOutputStream("C:\\Users\\hp\\IdeaProjects\\JavaI\\AddressBookJavaFileIO\\src\\contact.txt", true), "UTF-8");
